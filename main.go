...
func setDB() {
	...
	p, _ = hashPassword("Test1234")
	addUser(database, "MouhamadouFaDiop", "mouhamadoufadilou.diop@gmail.com", p)
	p, _ = hashPassword("ZoomZoomZap")
	addUser(database, "MaBalde", "mabalde@gmail.com", p)
	p, _ = hashPassword("mabalde2023")
	addUser(database, "SerWade", "serwade@gmail.com", p)
